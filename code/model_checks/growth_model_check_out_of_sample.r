...
test <- read_csv("data/growth_data_test.csv")
...
r_pred_obs <- apply(growth_exp, 2, function(i) cor(i, d$ann_dia_growth))

# Calculate predicton intervals and coverage ----
...
saveRDS(out, "results/model_checks/growth_check_out_of_sample.rds")
